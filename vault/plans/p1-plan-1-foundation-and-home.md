...
- - [x] **T14.D — per-endpoint stale table**
...
- [x] **T18.B — compact + expanded states**
...
- - [x] **T19.C — rail-level empty state (DESIGN.md §4.12)**
